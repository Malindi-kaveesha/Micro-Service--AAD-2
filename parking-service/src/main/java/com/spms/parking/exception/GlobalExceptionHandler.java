...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ParkingSpaceOccupiedException.class)
    public ResponseEntity<ErrorDetails> handleParkingSpaceOccupiedException(ParkingSpaceOccupiedException ex, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
